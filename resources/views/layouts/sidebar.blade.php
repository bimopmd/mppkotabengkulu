          ...
          <div class="js-sidebar-scroll">
            ...
            <div class="content-side content-side-full">
              <ul class="nav-main">
                ...
                <li>
                  <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-layers"></i><span class="sidebar-mini-hide">Instansi</span></a>
                  <ul>
                    <li>
                      <a href="{{route('instansi.index')}}">View Instansi</a>
                    </li>
                  </ul>
                </li>
              </ul>
