    ...
    <main id="main-container">
        ...
        <div class="bg-image bg-image-bottom" style="background-image: url({{url('assets/media/photos/photo35.jpg')}});">
            ...
            <div class="content content-top text-center overflow-hidden">
                ...
                <h1 class="font-w700 text-white mb-100 invisible" data-toggle="appear" data-class="animated fadeInUp">DATA USERS</h1>
                </div>
            </div>
            </div>
        </div>
                    ...
                    <div class="block">
                        ...
                        <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                            <thead>
                                ...
                                <th class="text-center" style="background-color: rgb(190, 190, 190);">Nama </th>
                                <th class="text-center" style="background-color: rgb(190, 190, 190);">Username</th>
                                <th class="text-center" style="background-color: rgb(190, 190, 190);">Email</th>
                                <th class="text-center" style="background-color: rgb(190, 190, 190);">Email Verified</th>
                                <th class="text-center" style="background-color: rgb(190, 190, 190);">Level User</th>
                                <th class="text-center" style="background-color: rgb(190, 190, 190);">Remember Token</th>
                                <th class="text-center" style="background-color: rgb(190, 190, 190);">Created</th>
                                <th class="text-center" style="background-color: rgb(190, 190, 190);">Updated</th>
